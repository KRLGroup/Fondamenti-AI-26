...
# "depth_first_search" devono ritornare un oggetto di tipo Node che rappresenti
# l'ultimo nodo della soluzione trovata. Il suo attributo "parent" dovrà
# puntare al penultimo nodo, che a sua volta dovrà puntare al precedente, ecc.
